...
namespace RoutinesLibrary.Services
{
    ...
    public class WindowsServiceManager
    {
        ...
        {
            add { InstallEventEvent = (InstallEventEventHandler) System.Delegate.Combine(InstallEventEvent, value); }
            remove { InstallEventEvent = (InstallEventEventHandler) System.Delegate.Remove(InstallEventEvent, value); }
        }
        ...
        {
            add { UninstallEventEvent = (UninstallEventEventHandler) System.Delegate.Combine(UninstallEventEvent, value); }
            remove { UninstallEventEvent = (UninstallEventEventHandler) System.Delegate.Remove(UninstallEventEvent, value); }
        }
