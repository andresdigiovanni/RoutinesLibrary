...
namespace RoutinesLibrary.Discovery
{
    ...
    public class DiscoveryHost
    {
        ...
        //UDP socket
        private RoutinesLibrary.Net.Protocols.UDPHelper m_SockUDP;
        ...
        public DiscoveryHost(string messageRequest, string messageResponse, ushort port, string localIPAdress = "")
        {
            ...
            //UDP socket
            m_SockUDP = new RoutinesLibrary.Net.Protocols.UDPHelper(m_Port);
            m_SockUDP.DataReceived += new RoutinesLibrary.Net.Protocols.UDPHelper.DataReceivedEventHandler(this.SockUDP_DataReceived);
            m_SockUDP.Activate();
        }
